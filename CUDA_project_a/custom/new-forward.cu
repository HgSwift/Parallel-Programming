    ...
    */
    ...
    if(h < H_out && w < W_out){
        ...
        for (c = 0; c < C; c++) { // sum over all input channels
            acc += (x4d(b, c, h, w+0)) * (k4d(m, c, 0, 0));
            acc += (x4d(b, c, h, w+1)) * (k4d(m, c, 0, 1));
            acc += (x4d(b, c, h, w+2)) * (k4d(m, c, 0, 2));
            acc += (x4d(b, c, h, w+3)) * (k4d(m, c, 0, 3));
            acc += (x4d(b, c, h, w+4)) * (k4d(m, c, 0, 4));
            acc += (x4d(b, c, h, w+5)) * (k4d(m, c, 0, 5));
            acc += (x4d(b, c, h, w+6)) * (k4d(m, c, 0, 6));
